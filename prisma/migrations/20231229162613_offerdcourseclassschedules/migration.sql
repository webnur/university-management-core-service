...
-- AddForeignKey
ALTER TABLE "offered_course_class_schedules" ADD CONSTRAINT "offered_course_class_schedules_faultyId_fkey" FOREIGN KEY ("faultyId") REFERENCES "faculties"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
